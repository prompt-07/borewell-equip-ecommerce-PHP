...
if(isset($_POST["category"])){
	...
	echo "
            ...
            <div class='aside'>
							<h3 class='aside-title' style='margin-left:30px; color:#1E1F29;'>Categories</h3>
		...
		if (mysqli_num_rows($query) > 0) {
			...
			<form method="post" action="login_form.php">
					...
					echo 
						...
						<tr>
							...
							<div class="btn-group">
								...
								<a href="#" class="btn btn-danger btn-sm remove" remove_id="'.$product_id.'">Remove</i></a>		
							</div>							
							</td>
						</tr>
				...
				<tfoot>
					...
					<tr>
						<td><a href="store.php" class="btn btn-warning">Continue Shopping</a></td>
